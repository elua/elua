...
/*! Memory map version 0.5 */
#define MCU_MEM_MAP_VERSION ((0 << 8) | 5)
...
typedef enum IRQn {
  ...
  CAN0_IMEU_IRQn               = 35,               /*!< CAN0 Individual Matching Elements Update (IMEU) Interrupt */
  CAN0_Lost_Rx_IRQn            = 36,               /*!< CAN0 Lost Receive Interrupt */
  ...
  CAN1_IMEU_IRQn               = 43,               /*!< CAN1 Individual Matching Elements Update (IMEU) Interrupt */
  CAN1_Lost_Rx_IRQn            = 44,               /*!< CAN1 Lost Receive Interrupt */
  ...
  HSCMP0_IRQn                  = 59,               /*!< HSCMP0 interrupt */
  HSCMP1_IRQn                  = 60,               /*!< HSCMP1 interrupt */
  HSCMP2_IRQn                  = 61,               /*!< HSCMP2 interrupt */
...
typedef struct {
  ...
  __IO uint32_t IMEUR;                             /*!< Individual Matching Elements Update Register, offset: 0x3C */
  __I  uint32_t LRFR;                              /*!< Lost Rx Frames Register, offset: 0x40 */
...
typedef struct {
  __IO uint32_t CRC;                               /*!< CRC Word Register, offset: 0x0 */
  __IO uint32_t GPOLY;                             /*!< Polynomial Word Register, offset: 0x4 */
...
typedef struct {
  ...
  __I  uint8_t SR;                                 /*!< DAC Status Register, offset: 0x20 */
...
typedef struct {
  ...
  __IO uint32_t RMON_T_CRC_ALIGN;                  /*!< RMON Tx Packets w CRC/Align error, offset: 0x210 */
  ...
  __IO uint32_t RMON_T_P_GTE2048;                  /*!< RMON Tx packets w > 2048 bytes, offset: 0x240 */
  __IO uint32_t RMON_T_OCTETS;                     /*!< RMON Tx Octets, offset: 0x244 */
  __IO uint32_t IEEE_T_DROP;                       /*!< Count of frames not counted correctly, offset: 0x248 */
  ...
  __IO uint32_t IEEE_T_OCTETS_OK;                  /*!< Octet count for Frames Transmitted w/o Error, offset: 0x274 */
  ...
  __IO uint32_t RMON_R_CRC_ALIGN;                  /*!< RMON Rx Packets w CRC/Align error, offset: 0x290 */
  ...
  __IO uint32_t RMON_R_P_GTE2048;                  /*!< RMON Rx packets w > 2048 bytes, offset: 0x2C0 */
  __IO uint32_t RMON_R_OCTETS;                     /*!< RMON Rx Octets, offset: 0x2C4 */
  __IO uint32_t RMON_R_DROP;                       /*!< Count of frames not counted correctly, offset: 0x2C8 */
  __IO uint32_t RMON_R_FRAME_OK;                   /*!< Frames Received OK, offset: 0x2CC */
  ...
  __IO uint32_t IEEE_R_OCTETS_OK;                  /*!< Octet count for Frames Rcvd w/o Error, offset: 0x2E0 */
...
typedef struct {
  ...
  __I  uint8_t NVPROT3;                            /*!< Non-volatile P-Flash Protection 1 - Low Register, offset: 0x8 */
  __I  uint8_t NVPROT2;                            /*!< Non-volatile P-Flash Protection 1 - High Register, offset: 0x9 */
  __I  uint8_t NVPROT1;                            /*!< Non-volatile P-Flash Protection 0 - Low Register, offset: 0xA */
  __I  uint8_t NVPROT0;                            /*!< Non-volatile P-Flash Protection 0 - High Register, offset: 0xB */
  __I  uint8_t NVDPROT;                            /*!< Non-volatile D-Flash Protection Register, offset: 0xC */
  __I  uint8_t NVEPROT;                            /*!< Non-volatile EERAM Protection Register, offset: 0xD */
  __I  uint8_t NVOPT;                              /*!< Non-volatile Flash Option Register, offset: 0xE */
  __I  uint8_t NVSEC;                              /*!< Non-volatile Flash Security Register, offset: 0xF */
} NV_Type;
...
#define NV_NVPROT3_PROT(x)                       (((uint8_t)(((uint8_t)(x))<<NV_NVPROT3_PROT_SHIFT))&NV_NVPROT3_PROT_MASK)
/* NVPROT2 Bit Fields */
#define NV_NVPROT2_PROT_MASK                     0xFFu
#define NV_NVPROT2_PROT_SHIFT                    0
#define NV_NVPROT2_PROT(x)                       (((uint8_t)(((uint8_t)(x))<<NV_NVPROT2_PROT_SHIFT))&NV_NVPROT2_PROT_MASK)
/* NVPROT1 Bit Fields */
#define NV_NVPROT1_PROT_MASK                     0xFFu
#define NV_NVPROT1_PROT_SHIFT                    0
#define NV_NVPROT1_PROT(x)                       (((uint8_t)(((uint8_t)(x))<<NV_NVPROT1_PROT_SHIFT))&NV_NVPROT1_PROT_MASK)
/* NVPROT0 Bit Fields */
#define NV_NVPROT0_PROT_MASK                     0xFFu
#define NV_NVPROT0_PROT_SHIFT                    0
#define NV_NVPROT0_PROT(x)                       (((uint8_t)(((uint8_t)(x))<<NV_NVPROT0_PROT_SHIFT))&NV_NVPROT0_PROT_MASK)
/* NVDPROT Bit Fields */
#define NV_NVDPROT_DPROT_MASK                    0xFFu
#define NV_NVDPROT_DPROT_SHIFT                   0
#define NV_NVDPROT_DPROT(x)                      (((uint8_t)(((uint8_t)(x))<<NV_NVDPROT_DPROT_SHIFT))&NV_NVDPROT_DPROT_MASK)
/* NVEPROT Bit Fields */
#define NV_NVEPROT_EPROT_MASK                    0xFFu
#define NV_NVEPROT_EPROT_SHIFT                   0
#define NV_NVEPROT_EPROT(x)                      (((uint8_t)(((uint8_t)(x))<<NV_NVEPROT_EPROT_SHIFT))&NV_NVEPROT_EPROT_MASK)
/* NVOPT Bit Fields */
#define NV_NVOPT_NVOPT_MASK                      0xFFu
#define NV_NVOPT_NVOPT_SHIFT                     0
#define NV_NVOPT_NVOPT(x)                        (((uint8_t)(((uint8_t)(x))<<NV_NVOPT_NVOPT_SHIFT))&NV_NVOPT_NVOPT_MASK)
/* NVSEC Bit Fields */
#define NV_NVSEC_SEC_MASK                        0x3u
#define NV_NVSEC_SEC_SHIFT                       0
#define NV_NVSEC_SEC(x)                          (((uint8_t)(((uint8_t)(x))<<NV_NVSEC_SEC_SHIFT))&NV_NVSEC_SEC_MASK)
#define NV_NVSEC_FSLACC_MASK                     0xCu
#define NV_NVSEC_FSLACC_SHIFT                    2
#define NV_NVSEC_FSLACC(x)                       (((uint8_t)(((uint8_t)(x))<<NV_NVSEC_FSLACC_SHIFT))&NV_NVSEC_FSLACC_MASK)
#define NV_NVSEC_MEEN_MASK                       0x30u
#define NV_NVSEC_MEEN_SHIFT                      4
#define NV_NVSEC_MEEN(x)                         (((uint8_t)(((uint8_t)(x))<<NV_NVSEC_MEEN_SHIFT))&NV_NVSEC_MEEN_MASK)
#define NV_NVSEC_KEYEN_MASK                      0xC0u
#define NV_NVSEC_KEYEN_SHIFT                     6
#define NV_NVSEC_KEYEN(x)                        (((uint8_t)(((uint8_t)(x))<<NV_NVSEC_KEYEN_SHIFT))&NV_NVSEC_KEYEN_MASK)
...
#define HSCMP0_BASE                              (0x40073000u)
/*! Peripheral HSCMP0 base pointer */
#define HSCMP0                                   ((CMP_Type *)HSCMP0_BASE)
/*! Peripheral HSCMP1 base address */
#define HSCMP1_BASE                              (0x40073008u)
/*! Peripheral HSCMP1 base pointer */
#define HSCMP1                                   ((CMP_Type *)HSCMP1_BASE)
/*! Peripheral HSCMP2 base address */
#define HSCMP2_BASE                              (0x40073010u)
/*! Peripheral HSCMP2 base pointer */
#define HSCMP2                                   ((CMP_Type *)HSCMP2_BASE)
...
typedef struct {
  __IO uint8_t A1;                                 /*!< IIC address register 1, offset: 0x0 */
  __IO uint8_t F;                                  /*!< IIC frequency divider register, offset: 0x1 */
  __IO uint8_t C1;                                 /*!< IIC control register 1, offset: 0x2 */
  __IO uint8_t S;                                  /*!< IIC status register, offset: 0x3 */
  __IO uint8_t D;                                  /*!< IIC data I/O register, offset: 0x4 */
  __IO uint8_t C2;                                 /*!< IIC control register 2, offset: 0x5 */
  __IO uint8_t FLT;                                /*!< IIC programmable input glitch filter, offset: 0x6 */
  __IO uint8_t RA;                                 /*!< IIC range address register, offset: 0x7 */
  __IO uint8_t SMB;                                /*!< IIC SMBus control and status register, offset: 0x8 */
  __IO uint8_t A2;                                 /*!< IIC address register 2, offset: 0x9 */
  __IO uint8_t SLTH;                               /*!< IIC SCL low timeout register high, offset: 0xA */
  __IO uint8_t SLTL;                               /*!< IIC SCL low timeout register low, offset: 0xB */
} I2C_Type;
...
typedef struct {
  ...
  __IO uint32_t CH0C1;                             /*!< Channel n Control Register 1, offset: 0x10 */
  __IO uint32_t CH0S;                              /*!< Channel n Status Register, offset: 0x14 */
  __IO uint32_t CH0DLY0;                           /*!< Channel n Delay 0 Register, offset: 0x18 */
  __IO uint32_t CH0DLY1;                           /*!< Channel n Delay 1 Register, offset: 0x1C */
       uint8_t RESERVED_0[24];
  __IO uint32_t CH1C1;                             /*!< Channel n Control Register 1, offset: 0x38 */
  __IO uint32_t CH1S;                              /*!< Channel n Status Register, offset: 0x3C */
  __IO uint32_t CH1DLY0;                           /*!< Channel n Delay 0 Register, offset: 0x40 */
  __IO uint32_t CH1DLY1;                           /*!< Channel n Delay 1 Register, offset: 0x44 */
       uint8_t RESERVED_1[264];
  __IO uint32_t DACINTC0;                          /*!< DAC Interval Trigger n Control Register, offset: 0x150 */
  __IO uint32_t DACINT0;                           /*!< DAC Interval n Register, offset: 0x154 */
  __IO uint32_t DACINTC1;                          /*!< DAC Interval Trigger n Control Register, offset: 0x158 */
  __IO uint32_t DACINT1;                           /*!< DAC Interval n Register, offset: 0x15C */
...
#define PDB_CH0C1_EN(x)                          (((uint32_t)(((uint32_t)(x))<<PDB_CH0C1_EN_SHIFT))&PDB_CH0C1_EN_MASK)
#define PDB_CH0C1_TOS_MASK                       0xFF00u
#define PDB_CH0C1_TOS_SHIFT                      8
#define PDB_CH0C1_TOS(x)                         (((uint32_t)(((uint32_t)(x))<<PDB_CH0C1_TOS_SHIFT))&PDB_CH0C1_TOS_MASK)
#define PDB_CH0C1_BB_MASK                        0xFF0000u
#define PDB_CH0C1_BB_SHIFT                       16
#define PDB_CH0C1_BB(x)                          (((uint32_t)(((uint32_t)(x))<<PDB_CH0C1_BB_SHIFT))&PDB_CH0C1_BB_MASK)
/* CH0S Bit Fields */
#define PDB_CH0S_ERR_MASK                        0xFFu
#define PDB_CH0S_ERR_SHIFT                       0
#define PDB_CH0S_ERR(x)                          (((uint32_t)(((uint32_t)(x))<<PDB_CH0S_ERR_SHIFT))&PDB_CH0S_ERR_MASK)
#define PDB_CH0S_CF_MASK                         0xFF0000u
#define PDB_CH0S_CF_SHIFT                        16
#define PDB_CH0S_CF(x)                           (((uint32_t)(((uint32_t)(x))<<PDB_CH0S_CF_SHIFT))&PDB_CH0S_CF_MASK)
/* CH0DLY0 Bit Fields */
#define PDB_CH0DLY0_DLY_MASK                     0xFFFFu
#define PDB_CH0DLY0_DLY_SHIFT                    0
#define PDB_CH0DLY0_DLY(x)                       (((uint32_t)(((uint32_t)(x))<<PDB_CH0DLY0_DLY_SHIFT))&PDB_CH0DLY0_DLY_MASK)
/* CH0DLY1 Bit Fields */
#define PDB_CH0DLY1_DLY_MASK                     0xFFFFu
#define PDB_CH0DLY1_DLY_SHIFT                    0
#define PDB_CH0DLY1_DLY(x)                       (((uint32_t)(((uint32_t)(x))<<PDB_CH0DLY1_DLY_SHIFT))&PDB_CH0DLY1_DLY_MASK)
/* CH1C1 Bit Fields */
#define PDB_CH1C1_EN_MASK                        0xFFu
#define PDB_CH1C1_EN_SHIFT                       0
#define PDB_CH1C1_EN(x)                          (((uint32_t)(((uint32_t)(x))<<PDB_CH1C1_EN_SHIFT))&PDB_CH1C1_EN_MASK)
#define PDB_CH1C1_TOS_MASK                       0xFF00u
#define PDB_CH1C1_TOS_SHIFT                      8
#define PDB_CH1C1_TOS(x)                         (((uint32_t)(((uint32_t)(x))<<PDB_CH1C1_TOS_SHIFT))&PDB_CH1C1_TOS_MASK)
#define PDB_CH1C1_BB_MASK                        0xFF0000u
#define PDB_CH1C1_BB_SHIFT                       16
#define PDB_CH1C1_BB(x)                          (((uint32_t)(((uint32_t)(x))<<PDB_CH1C1_BB_SHIFT))&PDB_CH1C1_BB_MASK)
/* CH1S Bit Fields */
#define PDB_CH1S_ERR_MASK                        0xFFu
#define PDB_CH1S_ERR_SHIFT                       0
#define PDB_CH1S_ERR(x)                          (((uint32_t)(((uint32_t)(x))<<PDB_CH1S_ERR_SHIFT))&PDB_CH1S_ERR_MASK)
#define PDB_CH1S_CF_MASK                         0xFF0000u
#define PDB_CH1S_CF_SHIFT                        16
#define PDB_CH1S_CF(x)                           (((uint32_t)(((uint32_t)(x))<<PDB_CH1S_CF_SHIFT))&PDB_CH1S_CF_MASK)
/* CH1DLY0 Bit Fields */
#define PDB_CH1DLY0_DLY_MASK                     0xFFFFu
#define PDB_CH1DLY0_DLY_SHIFT                    0
#define PDB_CH1DLY0_DLY(x)                       (((uint32_t)(((uint32_t)(x))<<PDB_CH1DLY0_DLY_SHIFT))&PDB_CH1DLY0_DLY_MASK)
/* CH1DLY1 Bit Fields */
#define PDB_CH1DLY1_DLY_MASK                     0xFFFFu
#define PDB_CH1DLY1_DLY_SHIFT                    0
#define PDB_CH1DLY1_DLY(x)                       (((uint32_t)(((uint32_t)(x))<<PDB_CH1DLY1_DLY_SHIFT))&PDB_CH1DLY1_DLY_MASK)
/* DACINTC0 Bit Fields */
...
#define PDB_DACINT0_INT(x)                       (((uint32_t)(((uint32_t)(x))<<PDB_DACINT0_INT_SHIFT))&PDB_DACINT0_INT_MASK)
/* DACINTC1 Bit Fields */
...
#define PDB_DACINT1_INT(x)                       (((uint32_t)(((uint32_t)(x))<<PDB_DACINT1_INT_SHIFT))&PDB_DACINT1_INT_MASK)
/* POEN Bit Fields */
...
typedef struct {
  __IO uint32_t PDOR;                              /*!< Port Data Output Register n, offset: 0x0 */
  __O  uint32_t PSOR;                              /*!< Port Set Output Register n, offset: 0x4 */
  __O  uint32_t PCOR;                              /*!< Port Clear Output Register n, offset: 0x8 */
  __O  uint32_t PTOR;                              /*!< Port Toggle Output Register n, offset: 0xC */
  __I  uint32_t PDIR;                              /*!< Port Data Input Register n, offset: 0x10 */
  __IO uint32_t POER;                              /*!< Port Output Enable Register n, offset: 0x14 */
} GPIO_Type;
...
/*! Peripheral RNGB base address */
#define RNGB_BASE                                (0x400A0000u)
/*! Peripheral RNGB base pointer */
#define RNGB                                     ((RNG_Type *)RNGB_BASE)
...
typedef struct {
  ...
  __IO uint32_t PEN;                               /*!< Pin Enable Register, offset: 0x8 */
       uint8_t RESERVED_0[4];
  __I  uint32_t WUCNTR;                            /*!< Wake-Up Channel Counter Register, offset: 0x10 */
       uint8_t RESERVED_1[236];
...
#define TSI_CNTR1_CNT(x)                         (((uint32_t)(((uint32_t)(x))<<TSI_CNTR1_CNT_SHIFT))&TSI_CNTR1_CNT_MASK)
/* CNTR3 Bit Fields */
#define TSI_CNTR3_CNT_MASK                       0xFFFFFFFFu
#define TSI_CNTR3_CNT_SHIFT                      0
#define TSI_CNTR3_CNT(x)                         (((uint32_t)(((uint32_t)(x))<<TSI_CNTR3_CNT_SHIFT))&TSI_CNTR3_CNT_MASK)
/* CNTR5 Bit Fields */
#define TSI_CNTR5_CNT_MASK                       0xFFFFFFFFu
#define TSI_CNTR5_CNT_SHIFT                      0
#define TSI_CNTR5_CNT(x)                         (((uint32_t)(((uint32_t)(x))<<TSI_CNTR5_CNT_SHIFT))&TSI_CNTR5_CNT_MASK)
/* CNTR7 Bit Fields */
#define TSI_CNTR7_CNT_MASK                       0xFFFFFFFFu
#define TSI_CNTR7_CNT_SHIFT                      0
#define TSI_CNTR7_CNT(x)                         (((uint32_t)(((uint32_t)(x))<<TSI_CNTR7_CNT_SHIFT))&TSI_CNTR7_CNT_MASK)
/* CNTR9 Bit Fields */
#define TSI_CNTR9_CNT_MASK                       0xFFFFFFFFu
#define TSI_CNTR9_CNT_SHIFT                      0
#define TSI_CNTR9_CNT(x)                         (((uint32_t)(((uint32_t)(x))<<TSI_CNTR9_CNT_SHIFT))&TSI_CNTR9_CNT_MASK)
/* CNTR11 Bit Fields */
#define TSI_CNTR11_CNT_MASK                      0xFFFFFFFFu
#define TSI_CNTR11_CNT_SHIFT                     0
#define TSI_CNTR11_CNT(x)                        (((uint32_t)(((uint32_t)(x))<<TSI_CNTR11_CNT_SHIFT))&TSI_CNTR11_CNT_MASK)
/* CNTR13 Bit Fields */
#define TSI_CNTR13_CNT_MASK                      0xFFFFFFFFu
#define TSI_CNTR13_CNT_SHIFT                     0
#define TSI_CNTR13_CNT(x)                        (((uint32_t)(((uint32_t)(x))<<TSI_CNTR13_CNT_SHIFT))&TSI_CNTR13_CNT_MASK)
/* CNTR15 Bit Fields */
#define TSI_CNTR15_CNT_MASK                      0xFFFFFFFFu
#define TSI_CNTR15_CNT_SHIFT                     0
#define TSI_CNTR15_CNT(x)                        (((uint32_t)(((uint32_t)(x))<<TSI_CNTR15_CNT_SHIFT))&TSI_CNTR15_CNT_MASK)
/* THRESHLD Bit Fields */
...
/*! Peripheral USBOTG0 base address */
#define USBOTG0_BASE                             (0x40072000u)
/*! Peripheral USBOTG0 base pointer */
#define USBOTG0                                  ((USB_Type *)USBOTG0_BASE)
