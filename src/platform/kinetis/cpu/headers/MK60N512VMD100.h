...
#if !defined(MCU_MK60N512VMD100_HEADER)  /* Check if this MCU has not been already activated... */
#define MCU_MK60N512VMD100_HEADER
...
#endif  /* #if !defined(MCU_MK60N512VMD100_HEADER) */
