...
platform_list = {  
  ...
  'kinetis' : { 'cpus' : [ 'MK60N512VMD100' ], 'toolchains' : [ 'codesourcery' ] },
...
romfs = { 'bisect' : [ 'bisect.lua' ],
          ...
          'led' : [ 'led.lua' ],
          'kinexamples' : [ 'kinled.lua', 'kinpwm.lua', 'hello.lua', 'info.lua', 'bisect.lua', 'TWR-K60N512.lua', 'kintouch.lua' ],
          'kingames' : [ 'hangman.lua', 'life.lua', 'kinsimon.lua' ],
          'piano' : [ 'piano.lua' ],
          'pwmled' : [ 'pwmled.lua' ],
...
file_list = { 'SAM7-EX256' : [ 'bisect', 'hangman' , 'led', 'piano', 'hello', 'info', 'morse' ],
              ...
              'MIZAR32' : [ ],
              'NETDUINO': [ ],
              'TWR-K60N512' : [ 'kinexamples', 'kingames' ]
}
